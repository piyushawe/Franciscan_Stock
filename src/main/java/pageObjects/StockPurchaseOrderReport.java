...
public class StockPurchaseOrderReport {
	 WebDriver dr;
	 String r="StockPurchaseOrderReport";
	 ...
	 @FindBy(id="ContentPlaceHolder1_ddlPurchaseOrderNo")WebElement order;
	 @FindBy(id="ContentPlaceHolder1_Button1")WebElement show;
	 
	 public StockPurchaseOrderReport(WebDriver d)
	 {
		 this.dr=d;
		 PageFactory.initElements(d, this);
	 }
	 public void openStockPurchaseOrderReport()
	 {
		WebElement menu= dr.findElement(By.xpath("//img[@src='/Images/layout/Reports.png']"));
		Actions builder= new Actions(dr);
		builder.moveToElement(menu).build().perform();
	    dr.findElement(By.linkText("Stock Purchase order Report")).click();
	    dr.switchTo().frame(dr.findElement(By.xpath("//iframe[@src='/Report/Stock/RptStkPurchaseOrder.aspx']")));
	 }
	 ...
	 public void selectOrder(String ord)
	 {
		 new Select(order).selectByVisibleText(ord);
	 }
