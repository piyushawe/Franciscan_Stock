...
public class EmployeeReturnReport {
	WebDriver dr;
	 String r="EmployeeReturnReport_";
	 ...
	 public EmployeeReturnReport(WebDriver d)
	 {
		 this.dr=d;
		 PageFactory.initElements(d, this);
	 }
	 public void openEmployeeReturnReport()
	 {
		WebElement menu= dr.findElement(By.xpath("//img[@src='/Images/layout/Reports.png']"));
		Actions builder= new Actions(dr);
		builder.moveToElement(menu).build().perform();
	    dr.findElement(By.linkText("Employee Return Report")).click();
	    dr.switchTo().frame(dr.findElement(By.xpath("//iframe[@src='/Report/Stock/EmployeeReturnReport.aspx']")));
	 }
