...
public class DefineItemCategory {
  WebDriver dr;
  String pg="DefineItemCategory";
  Utility u= new Utility();

  @FindBy(id="ContentPlaceHolder1_txtItemCatg_TextBox")WebElement itemcategory;
  @FindBy(id="ContentPlaceHolder1_txtDescriptiion_TextBox")WebElement description;
  ...
  public DefineItemCategory(WebDriver d)
  {
	  this.dr=d;
	  PageFactory.initElements(d, this); 
  }
  public void openDefineItemCategory()
  {
     WebElement menu= dr.findElement(By.xpath("//img[@src='/Images/layout/Global-Masters.png']"));
     Actions builder= new Actions(dr);
	 builder.moveToElement(menu).build().perform();
	 dr.findElement(By.linkText("Define Item Category")).click();
	 dr.switchTo().frame(dr.findElement(By.xpath("//iframe[@src='/StockManager/DefineItemCategory.aspx']")));
  }
  ...
  public void enterItemCategory(String  ictry)
  {
      itemcategory.sendKeys(ictry);
  }
  ...
  public void clickView(String school, Collection<String> sc)throws IOException
  {
      ...
      if (cells.size()>1) {
          for (WebElement cell : cells) {
              cell.findElement(By.xpath("//input[starts-with(@id,'ContentPlaceHolder1_rptItemCategory')]")).click();
              break;
          }
