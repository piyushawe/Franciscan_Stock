...
public class DefineBrandName {
  ...
  @FindBy(id="ContentPlaceHolder1_txtBrandName_TextBox")WebElement brandname;
  ...
  public void openDefineBrandName()
  {
	  ...
	  dr.findElement(By.linkText("Define Brand Name")).click();
	  dr.switchTo().frame(dr.findElement(By.xpath("//iframe[@src='/StockManager/DefineBrand.aspx']")));
  }
